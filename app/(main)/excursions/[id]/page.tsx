...
export async function generateMetadata({
  ...
  const description =
    excursionDescriptions[params.id]?.ru ||
    "Экскурсии по Беларуси с профессиональным гидом";
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `/og-excursion-${params.id}.webp`,
          width: 1200,
          height: 630,
          alt: title,
        },
    ...
    twitter: {
      ...
      title,
      description,
      images: [`/og-excursion-${params.id}.webp`],
    },
    alternates: {
  ...
  return [
    {
      ...
      duration:
        locale === "ru" ? "3 часа" : locale === "en" ? "3 hours" : "3小时",
      groupSize:
        locale === "ru"
          ? "до 15 человек"
          : locale === "en"
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/minsk-city-tour-architecture.webp",
        "/minsk-independence-avenue.webp",
        "/minsk-trinity-suburb.webp",
        "/minsk-upper-town-view.webp",
      ],
      highlights:
        locale === "ru"
          ? [
    ...
    },
    {
      ...
      duration:
        locale === "ru" ? "Полный день" : locale === "en" ? "Full day" : "全天",
      groupSize:
        locale === "ru"
          ? "до 20 человек"
          : locale === "en"
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/brest-fortress-memorial-belarus.webp",
        "/brest-fortress-entrance.webp",
        "/brest-fortress-monument.webp",
        "/brest-fortress-museum.webp",
      ],
      highlights:
        locale === "ru"
          ? [
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/nesvizh-castle-belarus-unesco.webp",
        "/mir-castle-belarus.webp",
        "/nesvizh-castle-interior.webp",
        "/mir-castle-towers.webp",
      ],
      highlights:
        locale === "ru"
          ? [
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/khatyn-memorial-belarus.webp",
        "/khatyn-eternal-flame.webp",
        "/khatyn-cemetery-villages.webp",
        "/khatyn-bells.webp",
      ],
      highlights:
        locale === "ru"
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/dudutki-museum-belarus-crafts.webp",
        "/dudutki-windmill.webp",
        "/dudutki-pottery-workshop.webp",
        "/dudutki-traditional-cuisine.webp",
      ],
      highlights:
        locale === "ru"
          ? [
      ...
      price:
        locale === "ru"
          ...
          : locale === "en"
            ...
            : "价格协商",
      images: [
        "/belovezhskaya-pushcha-forest.webp",
        "/belovezhskaya-pushcha-bison.webp",
        "/belovezhskaya-pushcha-ded-moroz.webp",
        "/belovezhskaya-pushcha-nature.webp",
      ],
      highlights:
        locale === "ru"
          ? [
