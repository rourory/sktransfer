...
export async function generateMetadata({
  ...
  const description =
    guideDescriptions[params.id]?.ru ||
    "Профессиональный гид по Минску и Беларуси";
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description,
      images: [`/og-guide-${params.id}.webp`],
    },
    alternates: {
  ...
  return [
    {
      ...
      experience:
        locale === "ru"
          ? "Более 15 лет в туризме"
          : locale === "en"
            ? "Over 15 years in tourism"
            : "旅游业超过15年",
      description:
        locale === "ru"
      ...
      tours: 1500,
      images: [
        "/andrey-guide-photo-1.webp",
        "/andrey-guide-photo-2.webp",
        "/andrey-guide-photo-1.webp",
      ],
      specializations:
        locale === "ru"
          ? [
              "Историческая Беларусь",
              "Архитектура Минска",
              "Военная история",
              "Культурные традиции",
            ]
