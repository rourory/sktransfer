...
import { PhoneContactLink } from "./phone-links/phone-contact-link";
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            <div className="flex-1 space-y-3">
              ...
              {contactMethods.map((method) => (
                ...
                >
                  <div
                    className={`p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br ${method.color} shadow-lg`}
                  >
                    <FontAwesomeIcon
                      icon={method.icon}
              ...
              <div className="grid grid-cols-2 gap-3">
                {messengers.map((messenger) => (
                  <a
                    ...
                    onClick={() => reachGoal("messanger_click")}
                    rel={
                      messenger.name === "WeChat"
                        ? undefined
                        : "noopener noreferrer"
                    }
